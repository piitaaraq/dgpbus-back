...
from .models import Hospital, Schedule, Patient, Appointment, Accommodation, SiteUser
...
class AppointmentViewSet(viewsets.ModelViewSet):
    ...
    parser_classes = [JSONParser]
    permission_classes = [IsAuthenticated, SiteUser]  # class-level default
    ...
    @action(detail=False, methods=['get'], url_path='alle-aftaler', permission_classes=[IsAuthenticated, SiteUser])
    ...
    @action(detail=False, methods=['get'], url_path='taxi-users', permission_classes=[IsAuthenticated, SiteUser])
    ...
    @action(detail=True, methods=['patch'], url_path='toggle-status', permission_classes=[IsAuthenticated, SiteUser])
    ...
    @action(detail=True, methods=['patch'], url_path='toggle-taxi', permission_classes=[IsAuthenticated, SiteUser])
    ...
    @action(detail=False, methods=['get'], url_path='find-patient', permission_classes=[IsAuthenticated, SiteUser])
    ...
    @action(detail=False, methods=['post'], url_path='calculate-bus-time', permission_classes=[AllowAny])  # tighten if needed
